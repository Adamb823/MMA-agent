...
def generate_fighter():
    """adjust fighter stats to match their fighting archetype """
...
def improve_archetype_stats(fighter_stats, fighter_style):
    """generate a potential rating based on the fighters age"""
...
def generate_potential(fighter_age):
    """create and return a list containing the requested number of fighters"""
    if fighter_age <= 22:
